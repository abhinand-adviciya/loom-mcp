...
This repo holds only `server.json` — the descriptor published to the [official MCP Registry](https://registry.modelcontextprotocol.io) (surfaced at [github.com/mcp](https://github.com/mcp)) under the name `io.github.abhinand-adviciya/loom`. It does not contain any Loom application source code.
